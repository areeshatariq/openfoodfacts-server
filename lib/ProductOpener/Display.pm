...
# configuration for html template::toolkit
...
sub display_nutrition_table($$) {
	...
	if ((defined $comparisons_ref) and (scalar @$comparisons_ref > 0)) {
		...
		# $comparison_val = lang("nutrition_data_comparison_with_categories");
...
;
	...
	my $template_data_ref = {
		...
		# comparison_name => $comparison_ref->{name},
...
# ;
	...
	# my $out;
	$tt->process('nutrition_fact_table.html', $template_data_ref, \$html) || return "template error: " . $tt->error();
